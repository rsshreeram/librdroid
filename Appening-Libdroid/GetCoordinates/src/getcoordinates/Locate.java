...
public class Locate {
    ...
    public static void main(String[] args) {
        try {
            ...
            String[] locations = new Locate().LocateArea("http://libris.kb.se/bib/7275172");
            String[] locationdiv = null;
            String[][] ordinates = null;
            int i = 0;
            
            for (String location : locations) {
                locationdiv[i++] = location.replace(" ", "+");
                GetCordinates coordinates = new GetCordinates();
                ordinates[i] = coordinates.MainCoordinate(locationdiv[i]);
            }
    ...
    public String[] LocateArea(String httpString) throws IOException {
        URL url = null;
        String inputLine;
        ...
        ite = library.iterator();
        int i = 0;
        while(ite.hasNext()) {
            Lib[i++] = (String) ite.next();
            if (i == 100) {
                break;
            }
        }
